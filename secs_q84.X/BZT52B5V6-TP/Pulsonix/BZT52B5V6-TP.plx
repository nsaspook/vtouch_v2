...
(library Library_1
	...
	(patternDef "SOD3716X135N" (originalName "SOD3716X135N")
		...
		(layerContents (layerNumRef 28)
			(line (pt -1.35 0.275) (pt -0.825 0.8) (width 0.025))
		)
		(layerContents (layerNumRef 18)
	...
	(compDef "BZT52B5V6-TP" (originalName "BZT52B5V6-TP") (compHeader (numPins 2) (numParts 1) (refDesPrefix Z)
		...
		(attr "<Hyperlink>" "https://componentsearchengine.com/Datasheets/1/BZT52B5V6-TP.pdf")
		(attr "<Component Height>" "1.35")
		(attr "<STEP Filename>" "BZT52B5V6-TP.stp")
