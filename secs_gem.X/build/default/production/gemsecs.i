...
# 105 "./mcc_generated_files/uart2.h"
...
# 251 "./mcc_generated_files/uart2.h"
_Bool UART2_is_tx_done(void);
# 300 "./mcc_generated_files/uart2.h"
...
{
 uint8_t rxData;
 static uint8_t retry, requeue = 0;
...
void terminal_format(DISPLAY_TYPES t_format)
{
 ...
 case display_message:
  sprintf(V.terminal, msg0,
   V.all_errors, V.r_l_state, V.failed_receive, V.t_l_state, V.failed_send, V.checksum_error, "1.70A");
  break;
 case display_online:
